...
<div class="d-flex justify-content-between px-3 mb-3">
	<h4>{current(uri)}</h4>
	<a href="#focus" on:click="{op_caret}" data-toggle="collapse">
		{#if caret}
...
<div class="collapse show row mb-3" id="focus">
	<div class="card card-body bg-white">
		<div class="custom-control custom-checkbox py-3 pl-5 pr-3 mb-2 d-flex justify-content-end">
		...
		<div>
			...
			<a href=" " class="d-inline-block text-dark py-2 px-2 mnv active">不限</a>
			{#each addr as {text,value}}
			<a href="#{value} " class="d-inline-block text-dark py-2 px-2 mnv ">{text}</a>
			{/each}		
		</div>
		<div class="border-top pt-3">
			<a href=" " class="text-dark d-inline-block py-1 px-2 mnv active">松江</a>
			<a href=" " class="text-dark d-inline-block py-1 px-2 mnv">崇明</a>
			<a href=" " class="text-dark d-inline-block py-1 px-2 mnv">浦东</a>
		</div>
		<div class="border-top pt-3">
			<a href=" " class="text-dark d-inline-block py-1 px-2 mnv active">松汇</a>
		</div>
		</div>
		<div class="bg-light p-3 rounded mt-3">
			<div class="d-flex">
				<p class="mt-1 font-weight-bold">行业：</p>
				<div class="">
					<a href=" " class="text-dark d-inline-block py-1 px-2 mnv active">不限</a>
					<a href=" " class="text-dark d-inline-block py-1 px-2 mnv ">上海</a>
				</div>			
			</div>
			<div class="border-top pt-3">
				<a href=" " class="text-dark d-inline-block py-1 px-2 mnv active">松江</a>
